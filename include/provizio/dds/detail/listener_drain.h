...
namespace provizio::dds::detail
{
    ...
    class listener_drain
    {
      public:
         ...
         * slice per line.
         */
        explicit listener_drain(const std::chrono::milliseconds slice) noexcept
            : stall_warning_period{slice > std::chrono::milliseconds::zero() ? slice : std::chrono::milliseconds{1}}
        {
        }
