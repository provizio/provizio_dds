...
def main():
    ...
    async def handle_request(request: provizio_dds.Int32) -> provizio_dds.Int64:
        ...
        # Drop divisible-by-4 immediately (pre-await)
        if value % 4 == 0:
            raise provizio_dds.Service.IgnoreRequest()
        # Otherwise, drop other evens inside await path
